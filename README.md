...
<img src="https://capsule-render.vercel.app/api?type=waving&color=6366f1&height=200&section=header&text=Mridul%20Gupta&fontSize=52&fontColor=ffffff&fontAlignY=38&desc=Full-Stack%20Developer%20%7C%20AI%2FML%20Enthusiast&descAlignY=58&descSize=18" width="100%"/>

<br/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=6366F1&center=true&vCenter=true&width=600&lines=Building+production-grade+web+apps;Embedding+AI+into+real-world+systems;B.Tech+CSE+%40+KIIT+%2727;Open+to+SDE+%26+AI%2FML+Internships)](https://git.io/typing-svg)
...
![Profile Views](https://komarev.com/ghpvc/?username=Mridul-gupta678&color=6366f1&style=for-the-badge&label=Profile+Views)
...
**[🔗 Live Demo](https://ai-interview-platform-rosy.vercel.app/) · [📂 Source](https://github.com/Mridul-gupta678/pricepilot)**
...
> **Stack:** `Next.js` · `PostgreSQL (Neon)` · `Tailwind CSS` · `Vercel AI SDK`
...
| | Credential |
|---|---|
| 🎓 | **Red Hat System Administration I (RH124)** — Certificate of Attendance |
| ☕ | **Spring Boot Framework Java** — Course Certification |
| 🤖 | **Cisco Modern AI Training Program** — Certification |
| 📊 | **TATA GenAI Data Analytics** — Certification |
| 📈 | **AlgoUniversity Graph Theory Programming Camp** — Certificate |
| 💻 | **200+ coding problems** solved across competitive platforms |
